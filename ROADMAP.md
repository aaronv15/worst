...
- [x] Fix 'Io Error: opening state file: No such file or directory (os error 2)' // Bug=N3

## Documentation:

- [x] Write documentation for modules:
  - [x] Document args.rs // Doc=N7
  - [x] Document files.rs // Doc=N8
  - [x] Document lib.rs // Doc=N9
- [x] Write usage documentation // Doc=N10

## Tests:

- [x] Args module // Tes=N4
- [x] Files module // Tes=N5
- [ ] Lib // Tes=N6
- [ ] All // Tes=N7
